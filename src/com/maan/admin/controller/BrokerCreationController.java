...
public class BrokerCreationController extends HttpServlet 
{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)	throws IOException, ServletException 
	{
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("BankMaster")) {
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("BankMasterDetails")) 
		{
			String bankError = "";
		...
		// / End for Bank Master  ///
		// OfficeShield
		else if (req.getParameter("requestfrom").equalsIgnoreCase("commisionforOfficeScheme")) 
		{
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("commisionforBroker")) 
		{
			...
			{
				String status = bc.insertOrUpdate(bcode, loginPersonId,(String)session.getAttribute("LoginBranchCode")); 
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("RSAusers1")) 
		{
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("ExchangeRate")) 
		{
...
//			 Effective Dtae Validation
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("Currency")) 
		{
			String adminCountryId ="";
			adminCountryId = (String)session.getAttribute("AdminCountryId"); 
			String remarkText = req.getParameter("remarkText") == null ? "": req.getParameter("remarkText");
			...
			String error = bc.validateCurrencyType();
		...
		/***/
		else if (req.getParameter("requestfrom").equalsIgnoreCase("CurrencySelection")) 
		{
			String adminCountryId ="";
			String error ="";
			adminCountryId = (String)session.getAttribute("AdminCountryId"); 
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("cutomerlist")) 
		{
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("BrokerLoginCreation")) 
		{
			String bcode = req.getParameter("bcode") == null ? "" : req.getParameter("bcode");
			loginPersonId = req.getParameter("loginPersonId") == null ? "": req.getParameter("loginPersonId");
			String brokerId = req.getParameter("BrokerId") == null ? "" : req.getParameter("BrokerId");
			...
			if (error.length() > 0) {
				...
				bc.updateLoginId(brokerId, branchCode,bcode);
				//End
		...
		else if (req.getParameter("requestfrom").trim().equalsIgnoreCase("policy_search"))
		{
			try {
				String error = "";
				String values = null;
		...
		else if (req.getParameter("requestfrom").trim().equalsIgnoreCase("policyCancel")) 
		{
		...
		else if (req.getParameter("requestfrom").trim().equalsIgnoreCase("portfolio")) 
		{
				try {
					String error = "";
					String values = null;
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("reports")) 
		{
			try {
				String individual = "";
				String error = "";
				...
				String data2 = (req.getParameter("dobDay1") + "-"
						...
						.getParameter("dobYear1"));
				String productId = req.getParameter("pid") == null ? "" : req
						.getParameter("pid");
				String userType = req.getParameter("userType") == null ? "" : req.getParameter("userType");
				cc.setUserType(userType);
				if (!print123.equalsIgnoreCase("YES")) 
				{
					error = cc.validateFields(req.getParameter("requestfrom"));
				} 
				else 
				{
				...
				else 
				{
					...
					{
						String brokerLogin = req.getParameter("selectBrokers");
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("reports1")) 
		{
			try {
		...
		/*else if (req.getParameter("requestfrom").equalsIgnoreCase("RAllowed"))
		{
			RequestDispatcher rd = null;
			String bcode = req.getParameter("bcode") == null ? "" : req.getParameter("bcode");
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("Brokersreport"))
		{
			com.maan.admin.DAO.BrokerCreationBean cc = new com.maan.admin.DAO.BrokerCreationBean();
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("newuser"))
		{
			String error="";
			RequestDispatcher rd =null;
			com.maan.admin.DAO.BrokerCreationBean brokerBean = new com.maan.admin.DAO.BrokerCreationBean();
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("newUserMenuSelection"))
		{
			boolean flag=false;
			String error="";
			RequestDispatcher rd =null;
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("newRSAuser"))
		{
			String error="";
			RequestDispatcher rd =null;
			com.maan.admin.DAO.BrokerCreationBean brokerBean = new com.maan.admin.DAO.BrokerCreationBean();
			...
			productId[0] = req.getParameter("travel")==null?"":req.getParameter("travel");
			productId[1] = req.getParameter("health")==null?"":req.getParameter("health");	
			String loginCountry ="";
			loginCountry = (String)session.getAttribute("AdminCountryId");
			...
			if(error.length() >0)
			{
				...
				req.setAttribute("travel", productId[0]);
				req.setAttribute("health", productId[1]);
		...
		else if(req.getParameter("requestfrom").equalsIgnoreCase("OpenCoverCertificate"))
		{
		...
		else if (req.getParameter("requestfrom").equalsIgnoreCase("newRSAUserBroSelection"))
		{
			boolean flag=false;
			String error="";
			RequestDispatcher rd =null;
			...
			{	
				if(req.getParameter("sel"+i) != null)
				{
					...
					String dobDay = req.getParameter("dobDay"+i) == null ? "0": req.getParameter("dobDay"+i);
					String dobMonth = req.getParameter("dobMonth"+i) == null ? "0": req.getParameter("dobMonth"+i);
					String dobYear = req.getParameter("dobYear"+i) == null ? "0": req.getParameter("dobYear"+i);
					...
					String dobDay2 = req.getParameter("dobDay2"+i) == null ? "0": req.getParameter("dobDay2"+i);
					String dobMonth2 = req.getParameter("dobMonth2"+i) == null ? "0": req.getParameter("dobMonth2"+i);
					String dobYear2 = req.getParameter("dobYear2"+i) == null ? "0": req.getParameter("dobYear2"+i);
					String cdate = "";
					...
					brokerBean.setDobDay(dobDay);
					brokerBean.setDobMonth(dobMonth);
					brokerBean.setDobYear(dobYear);
					brokerBean.setDobDay1(dobDay1);
					brokerBean.setDobMonth1(dobMonth1);
					brokerBean.setDobYear1(dobYear1);
					brokerBean.setDobDay2(dobDay2);
					brokerBean.setDobMonth2(dobMonth2);
					brokerBean.setDobYear2(dobYear2);
			...
			if(rd!=null)
				rd.forward(req,res);
		}else if (req.getParameter("requestfrom").equalsIgnoreCase("brokerMaster")){
		...
		}else if (req.getParameter("requestfrom").equalsIgnoreCase("policyType"))
		{
			System.out.println(">>> policyType Block - Enter");
			...
			{
				PolicyType =  brokerBean.getPolicyTypeDetails(bcode, proId,brokerId);
			}
			if(PolicyType!=null && PolicyType.length>0)
			{
				...
				{
					try{
					startRate=Double.parseDouble(request.getParameter("startRate"+PolicyType[k][0])==""?"0":request.getParameter("startRate"+PolicyType[k][0]));
					endRate=Double.parseDouble(request.getParameter("endRate"+PolicyType[k][0])==""?"0":request.getParameter("endRate"+PolicyType[k][0]));
					}catch(Exception e){System.out.println("vallllllllllllll"+request.getParameter("startRate"+PolicyType[k][0])+"Exception in conversion of Rate: "+e);}
					values+=",'"+PolicyType[k][0]+"'";
					values+=",'"+startRate/100+"'";
					values+=",'"+endRate/100+"'";
					values+=",'"+(request.getParameter("rateMod"+PolicyType[k][0])==null?"":request.getParameter("rateMod"+PolicyType[k][0]))+"'";
					values+=",'"+(request.getParameter("status"+PolicyType[k][0])==null?"":request.getParameter("status"+PolicyType[k][0]))+"'";
					values+=",to_date('"+(request.getParameter("effectiveDate"+PolicyType[k][0])==null?"":request.getParameter("effectiveDate"+PolicyType[k][0]))+"','dd-mm-yyyy')";
					
					PolicyType[k][3]=request.getParameter("startRate"+PolicyType[k][0])==null?"":request.getParameter("startRate"+PolicyType[k][0]);
					PolicyType[k][4]=request.getParameter("endRate"+PolicyType[k][0])==null?"":request.getParameter("endRate"+PolicyType[k][0]);
					PolicyType[k][5]=request.getParameter("rateMod"+PolicyType[k][0])==null?"":request.getParameter("rateMod"+PolicyType[k][0]);
					PolicyType[k][6]=request.getParameter("status"+PolicyType[k][0])==null?"":request.getParameter("status"+PolicyType[k][0]);
					PolicyType[k][7]=request.getParameter("effectiveDate"+PolicyType[k][0])==null?"":request.getParameter("effectiveDate"+PolicyType[k][0]);
					System.out.println("PolicyType[k][6]: "+PolicyType[k][6]);
					if(PolicyType[k][6].equals("Y"))
					{
						val.add(values);
						
						if(PolicyType[k][3].equalsIgnoreCase(""))
						{
							error+="Please Provide Start Rate in Row "+(k+1)+"</br>";
						}else 
						{
							err=brokerBean.validInteger(PolicyType[k][3]);
							if((err!=null && err.length()>0))
							{
								error+=err+" Start Rate in Row "+(k+1)+"</br>";
							}
						}
						if(PolicyType[k][4].equalsIgnoreCase(""))
						{
							error+="Please Provide End Rate in Row "+(k+1)+"</br>";
						}else 
						{
							err=brokerBean.validInteger(PolicyType[k][4]);
							if((err!=null && err.length()>0))
							{
								error+=err+" End Rate in Row "+(k+1)+"</br>";
							}
						}
						if(PolicyType[k][5].equalsIgnoreCase(""))
						{
							error+="Select Provision For Rate Modification in Row "+(k+1)+"</br>";
						}
						if(PolicyType[k][6].equalsIgnoreCase(""))
						{
							error+="Select Status in Row "+(k+1)+"</br>";
						}if(PolicyType[k][7].equalsIgnoreCase(""))
						{
							error+="Please Provide Effective Date in Row "+(k+1)+"</br>";
						}if(!PolicyType[k][3].equalsIgnoreCase("") || !PolicyType[k][4].equalsIgnoreCase(""))
						{
							if(endRate<startRate)
							error+="End Rate can't be less than Start Rate in Row "+(k+1)+"</br>";
						}
					}
					values="";
				}
			...
			if (error.length() > 0) {
				...
				dispatch = request.getRequestDispatcher("MotorPolicyTypeDetails.jsp?pid="+proId+"&bcode="+brokerId);
			} else {
				amendId=brokerBean.getMaxAmendId(proId, bcode, brokerId);
				for(int k=0; k<val.size(); k++)
				{
					brokerBean.insertPolicyTypeDetails(proId, bcode, brokerId, amendId,(String)val.get(k));
					msgsts=true;
				}
				if(msgsts)
			...
			System.out.println(">>> policyType Block - Exit");
			if(dispatch!=null){
				dispatch.forward(req, res);
			}
		}
