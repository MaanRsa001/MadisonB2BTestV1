...
public class ReferralValidation extends MyJdbcTemplate{
	...
	{
		LogManager.push("isCoverageReferral - Enter || coverId: "+coverId+" branchCode: "+branchCode);
		...
		LogManager.push("isCoverageReferral - Exit || Result: "+referral);
		return 	referral;	
	}
	public boolean isVesselReferral(String vesselId)
	{
		LogManager.push("isVesselReferral - Enter || vesselId: "+vesselId);
		boolean referral=false;
		String result="";
		try{
		...
		LogManager.push("isVesselReferral - Exit || Result: "+referral);
		return 	referral;	
	}
	public boolean isSameCountryReferral(String fromCountry, String toCountry)
	{
		LogManager.push("isSameCountryReferral - Enter || fromCountry: "+fromCountry+" toCountry: "+toCountry);
		boolean referral=fromCountry.equalsIgnoreCase(toCountry);
		LogManager.push("isSameCountryReferral - Exit || Result: "+referral);
		return 	referral;	
	}
	...
	{
		LogManager.push("isPolicyDateReferral - Enter");
		boolean referral=false;
		...
		LogManager.push("isPolicyDateReferral - Exit || Result: "+referral);
		return 	referral;	
	}
	...
	{
		LogManager.push("isLandReferral - Enter");
		boolean referral=false;
	...
	public boolean isCountryReferral(String fromCountry,String toCountry,String originCountry, String productId)
	{
		...
		LogManager.push("isCountryReferral - Exit || Result: "+referral);
		return referral;
	}
	...
	public boolean isCrossVoyageSIReferral(String fromCountry,String toCountry,String crossVoyage,String crossVoyageLimit,String openCoverNo,String originCountry, String totalSumInsured, String brokerType, String branchCode)
	{
		...
		LogManager.push("isCrossVoyageSIReferral - Enter");
		boolean referral=false;
		...
		LogManager.push("isCrossVoyageSIReferral - Exit || Result: "+referral);
		return referral;
	}
	...
	{
		LogManager.push("isSumInsuredReferral - Enter");
		boolean referral=false;
		try{
		...
		LogManager.push("isSumInsuredReferral - Exit || Result: "+referral);
		return referral;
	}
	...
	{
		LogManager.push("isLCSumInsuredReferral - Enter");
		boolean referral=false;
		try{
		...
		LogManager.push("isLCSumInsuredReferral - Exit || Result: "+referral);
		return referral;
	}
