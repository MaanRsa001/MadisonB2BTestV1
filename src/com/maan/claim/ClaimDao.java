...
public class ClaimDao extends MyJdbcTemplate {
	...
	public void getclaimDetails(ClaimBean bean, String policyNo) {
		try {
			LogManager.push("Method to getclaimDetails()");
	...
	public Integer getCountPolicyNo(ClaimBean bean) {
		...
		int count=0;
		try {
			LogManager.push("Method to getCountPolicyNo()");
	...
	public void getConditions(String applicationNo,String branchCode,ClaimBean bean)
	 {
		...
		List<String> clauseList=new ArrayList<String>();
	 	...
	 	try{
	 		...
	 		LogManager.push("getConditions - Exit || result");
	 	}catch (Exception e) {
			LogManager.debug("EXCEPTION @ { " + e + " }");
	 	}
	 }
	...
	public void saveLossDetails(ClaimBean bean) {
		...
		try {
			LogManager.push("saveLossDetails - Enter");
	...
	public List<Object> getClaimIntimation(ClaimBean bean) {
		...
		try {
			LogManager.push("ClaimIntimation - Enter");
	...
	public List<Object> getClaimPendingDetails(ClaimBean bean) {
		List<Object> result=new ArrayList<Object>();
		try{
			LogManager.push("ClaimPendingDetails - Enter");
	...
	public void getclaimIntimationDetails(ClaimBean bean) {
		try {
			...
			LogManager.push("ClaimIntimationDetails - Enter");
	...
	public int updateClaim(ClaimBean bean) {
		int update=0;
		try {
			LogManager.push("updateClaim - Enter");
