								...
								<table id="QuoteDocTable" cellpadding="1" class="footable" cellspacing="1" border="1">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<s:select name="documentIdList[%{0}]" id="documentIdList[%{0}]" cssClass="inputSelect" list="documentList" listKey="DOCUMENT_ID" listValue="DOCUMENT_DESC" headerKey="" headerValue="-Select-" />
											</td>
											<td>
		...
		var decision = confirm("File will be deleted. Do You Want to continue? ","");
			if (decision==true){
				...
				document.form1.submit();
					...
					document.form1.action = "${pageContext.request.contextPath}/documentUploadMotor";
					document.form1.submit();
				}
			return false;
		}
