   ...
   <img id="loading-image" src="${pageContext.request.contextPath}/images/madisonSymbolLogo.png"/>
	 ...
	 <div class="modal-header">
						...
						<table class="table  table-bordered table-hover" cellspacing="0" width="100%" id="tadaTableNew">
							...
							<tbody>
								<s:iterator value="vehDtls" var="view" status="status">
									<tr>
										<td align="center"><s:property value="#view.VehicleUsageName" /></td>
										<td align="center"><s:property value="#view.MakeName" /></td>					
										<td align="center"><s:property value="#view.ModelName" default=" " /> </td>
										<td align="center"><s:property value="#view.BodyName" /></td>
										<td align="center"> <s:property value="#view.SumInsured"/> </td>
										<%-- <td align="center"> <s:property value="getText('{0,number,#,##0.00}',{#view.SumInsured})"/> </td> --%>
									</tr>
								</s:iterator>
							</tbody>
						</table>
	              ...
	              <div class="col-md-6 DriverDetilsremove offset-md-3">
	                ...
	                <div class="row mt-2">
	                  <div class="col-md-12">
	                    ...
	                    <div id="ncbAjax"> <s:select name="noClaimBonusIdList[0]" id="noClaimBonus" list="noClaimBonusList" headerKey="" headerValue="---Claim Free Years(NCB)---" onchange="toggleNCB(this.value);" class="form-control" disabled="#disable1" listKey="Code" listValue="Description" theme="simple"/> </div>
	                  </div>
	                </div>
	                <div class="row mt-3">
	                  <div class="col-md-12">
	                ...
	                <div class="prevInfo">
		                ...
		                <div class="row mt-3">
		                  <div class="col-md-12">
		                    ...
		                    <s:select name="prevInsCompanyIdList[0]" id="prevInsCompanyIdList" list="insCompanyList" listKey="Code" listValue="Description" headerKey="" headerValue="---Previous Policy Insurance Company---" class="form-control"  />
		                  </div>
		                </div>
	                </div>
	              </div>
	        ...
	        <div class="modal-footer">
			  ...
			  <s:else> --%>
			  	<button type="button" class="btn btn-danger btn-block col-md-3" onclick="this.form.actionType.value='getSaveDriver';disableForm(this.form,false,'');return fnSaveDriverNew('driverUpdateAjaxMotor','<s:property value="deleteVehicleId"/>','<s:property value="applicationNo"/>')">Save</button>
			  <%-- </s:else> --%>
	        ...
	        <script>
		       ...
		       function fnSaveDriverNew(action,vehicleId,appNo) {
