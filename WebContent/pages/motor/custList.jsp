			      ...
			      <tbody class="rowevencolor">
			    	<s:iterator value="customerList" var="view" status="status">
				        <tr>
							...
							<td align="center"><s:property value="#view.CustomerName" /></td>
							<td align="center"><s:property value="#view.EmailId" /> </td>
							<td align="center"><s:property value="#view.ContactNo" /></td>
							<td align="center">
					            <div class="action_icons">
					               <a href="#" onclick="fnSubmit('<s:property value="CustomerId" />','<s:property value="%{#session.product_id}"/>')"><i class="fas fa-user-edit"></i></a>
					            </div>
							</td>
							<td align="center">
					            <div class="action_icons">
					               <a href="#" data-refresh="true" data-keyboard="false" data-toggle="modal" data-target="#custModal" onclick="fnEdit('<s:property value="#view.CustomerId" />','custEditAjax')"><i class="fas fa-pencil-alt"></i></a>
					            </div>
							</td>
							<td align="center"><s:property value="#view.Nrc" /></td>
							<td align="center"><s:property value="#view.PassportNo" /></td>
