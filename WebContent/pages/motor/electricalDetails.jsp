...
<html>
	...
	<body>
						...
						<div class="panel panel-primary">
		        			...
		        			<div class="panel-body">
								<table style="border-collapse: collapse;" class="footable" border="0" width="100%;" id="EmlTable">
							    			...
							    			<tbody>
							    			 <s:if test="%{elecSno!=null && elecSno.size()>0}">
						            			<s:iterator value="elecSno" var="snolist" status="stat">			    			
									    			<tr>
									    			    <td class="deleteCol" align="center">
									    			      	<s:text name="%{#stat.count}"></s:text>
									    			     	<s:hidden name="elecSno[%{#stat.count-1}]" id="elecSno%{#stat.count-1}"/>
										    			</td>
									    			    <td class="cCol">
									    					<s:textfield name="elecDescrip[%{#stat.count-1}]" id="elecDescrip[%{#stat.count-1}]" cssClass="inputBox"  />
									    				</td>									    			    
									    				<td class="cCol">
									    				    <s:textfield name="elecAmount[%{#stat.count-1}]" cssClass="inputBox" maxLength="100" disabled="#disableuw"/>
									    				</td> 
									    				<td>
									    	  ...
									    	  <s:else>									    	  		 
									    			 <tr>
									    			    <td class="deleteCol" align="center">
									    			      	1
									    			     	<s:hidden name="elecSno[0]" id="elecSno0"/>
										    			</td>
									    			    <td class="cCol">
									    					<s:textfield name="elecDescrip[0]" id="elecDescrip[0]" cssClass="inputBox"  />
									    				</td>									    			    
									    				<td class="cCol">
									    				    <s:textfield name="elecAmount[0]" id="elecAmount[0]" cssClass="inputBox" maxLength="100" disabled="#disableuw"/>
									    				</td>
									    				 <td class="cCol">
									    				    <input type="checkbox"/>
									    				</td>
		...
		function addEml(){
			...
			cell.innerHTML = (rowCount+1)+'<br><input type="hidden" name="elecSno['+rowCount+']" value="" id="elecSno'+rowCount+'"/>';
			
			cell = row.insertCell(1);			
			var element = document.createElement("input");
			element.className = "inputBox";
			element.name = "elecDescrip["+rowCount+"]";
			element.id = "elecDescrip";
			element.type = "text";			 
			...
			element.className = "inputBox";
			element.type = "text";
			element.name = "elecAmount["+rowCount+"]";
			element.maxlength = "50";
			element.id = "elecAmount[0]";
			cell.appendChild(element);
		...
		function save(){
			document.form1.action = "${pageContext.request.contextPath}/insertElectricMotor";
