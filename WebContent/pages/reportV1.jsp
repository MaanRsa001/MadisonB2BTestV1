...
<body>
<s:form name="report" id="report" theme="simple">
			...
			<div class="container vehDtl">
				...
				<div class="panel panel-heading">
					...
					<s:if test='menuType!="CHART"'>
						 <div class="VehicleTableheading">
					       <div class="row">
					          <div class="col-md-12">
					            <h3><s:text name="report.%{menuType}" /></h3><hr>
					          </div>
					       </div>
					    </div>
				...
				<div class="panel-body" style="padding-top: 0px;">
		  					...
		  					<s:if test='(#session.usertype==getText("BROKER") || (#session.product_id!=getText("OPEN_COVER") && #session.usertype==getText("ISSUER")))'>
		  						...
		  						<s:else>
		  							<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
										...
										<div class="tbox">
											<s:select list="userSelection" class="form-control" listKey="LOGIN_ID" listValue="USERNAME" name="loginId" headerKey="" headerValue="Select" onchange="userSelectReport(this)" disabled='issuer !=null && issuer.length() > 0 && #session.product_id==getText("OPEN_COVER")' />
										</div>
									</div>
		  						</s:else>
		  					</s:if>
		  			...
		  			<s:if test='menuType=="R"'>
						<div class="boxcontent">
							...
							<table class="tableWidth">
								<tr>
									<td width="50%"><b><s:text name="report.startDate" /><font color="red">*</font></b></td>
									<td width="50%"><s:textfield id="rpolicyStartDateSearch" name="policyStartDate" cssClass="form-control datepicker" readonly="true" disabled="#disable" /></td>
								</tr>
								<tr><td colspan="2" height="5"></td></tr>
								<tr>
									<td><b><s:text name="report.endDate" /><font color="red">*</font></b></td>
									<td><s:textfield id="rpolicyEndDateSearch" name="policyEndDate" cssClass="form-control datepicker" readonly="true" disabled="#disable" /></td>
								</tr>
								<tr><td colspan="2" height="5"></td></tr>
								<s:if test='#session.usertype!=getText("USER")'>
									<tr>
										<td><b><s:text name="report.selectuser"/><font color="red">*</font></b></td>
										<td><s:select name="userLoginId" id="userLoginId" list="policyList1" headerKey="ALL" headerValue="-ALL-"  listKey="FIRST_NAME" listValue="USERNAME" cssClass="form-control" /></td>
									</tr>									
								</s:if>
								<s:else>
					...
					<s:elseif test='menuType=="PR"'>
						<div class="row ">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
<!-- 								<table class="table table-bordered table-sm" id="record" width="100%" cellspacing="0"> -->
...
<!-- 									<thead> -->
					...
					<s:elseif test='menuType=="PVD"'>
			  			<s:if test='"Claim".equals(reqFrom) || "Endorse".equals(reqFrom)'>
			  				<div class="row">
				  				<div class="col-xs-12 col-md-4 col-lg-4 col-sm-4">
					  				<b><s:label key="endt.policyNo"/></b>
					  				<s:select list="policyNoList" cssClass="form-control" listKey="POLICY_NO" listValue="POLICY_NO" name="policyNo"  headerKey="" headerValue="Select"  onchange="getMotorDetails(this.value,'%{reqFrom}')"/>
				  				</div>
				  			</div>
				  			<s:if test='policyNo!=null && policyNo!=""'>
					  			...
					  			<div class="boxcontent">
									<table class="table table-bordered table-sm" id="tadaTable" width="100%" cellspacing="0">
											<thead class="bluecolortable">
												<tr>
													<!-- <th class="no-sort"></th> -->
													<th><s:text name="S.No." /></th>
														...
														<tr>
															...
															<s:if test='reqFrom=="Claim"'>
																<td align="center">
																	...
																	<!-- <a href="#"><i class="btn btn-sm btn-success" onclick="claim('%{#record1.VEHICLE_ID}','%{#session.product_id}','individual')" ></i></a> -->
			  			...
			  			<s:else>
							<div class="row">
								<div class="col-md-12  ">
									<b><s:label key="endt.policyNo"/> : <span class="text-primary"><s:property value="%{policyNo}"/></span></b>
									<br/><font color="green"><s:property value="%{actionMsg}"/></font>
								</div>
							</div>
				  			<div class="boxcontent">
<!-- 								<table class="table table-bordered table-sm" id="gridTable" width="100%" cellspacing="0"> -->
...
<%-- 													<s:a href="#" cssClass="btn btn-sm btn-primary" onclick="return getFleetPdf('%{#record1.QUOTE_NO}','%{#record1.VEHICLE_ID}')"><i class="glyphicon glyphicon-book"></i></s:a> --%>
													<button type="submit" onClick="return getFleetPdf('<s:property value="#record1.QUOTE_NO"/>','<s:property value="#record1.VEHICLE_ID"/>')" class="btn btn-sm btn-primary">
...
<%-- 												<a href="#" onClick="viewQuote(<s:property value="#record.QUOTE_NO" />)" ><i class="fa fa-print"></i></a> --%>
												<button type="submit" onClick="viewQuote(<s:property value="#record.QUOTE_NO" />)" class="btn btn-sm btn-primary">
			  		...
			  		<s:elseif test='menuType=="RP" || menuType=="RC" || menuType=="RE" '>
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<table class="table table-bordered table-hover" cellspacing="0" width="100%" id="tadaTable">
										<thead class="bluecolortable" >
										<tr>
											...
											<th><s:text name="Chassis No" /></th>
											<s:if test='menuType=="RP"'>
										...
										<tr valign="middle">
											...
											<td><s:property value="griskId"/></td>
											<td><s:property value="gchassisNo"/></td>
											<s:if test='menuType=="RP"'>
											<td align="center">
													<a href="#" type="button" class="btn btn-sm btn-info" onClick="getRenew('<s:property value="gpolicyNo" />','<s:property value="gmobile" />')"><i class="glyphicon glyphicon-book"></i></a> 
											</td>
											</s:if>
										</tr>
										</s:iterator>
												...
												<s:else><!-- #session.product_id=="30" -->
													...
													<s:if test='%{("User".equalsIgnoreCase(#session.usertype))}'>
														<s:if test='"Y".equals(ginstallmentYN)'>
															<td align="center">
																<a href="#" type="button" class="btn btn-sm btn-outline-primary" onClick="fnView('<s:property value="gquoteNo" />')"><i class="glyphicon glyphicon-book"></i></a> 
															</td>
														</s:if>
														<s:else>
															<td align="center">
																<a href="#" type="button" class="btn btn-sm btn-outline-primary" onClick="fnView1('<s:property value="gquoteNo" />','<s:property value="gmerchent" />')"><i class="glyphicon glyphicon-book"></i></a> 
															</td>
														</s:else>
													</s:if>
													<td align="center">
													...
													<s:if test='%{#session.product_id=="65"}'>
														<td align="center">
															<a href="#" type="button" class="btn btn-sm btn-outline-primary" onClick="motorVehicleDetails('${report.gpolicyNo}')"><i class="glyphicon glyphicon glyphicon-list-alt"></i></a>
														</td>
													</s:if>
													...
													<s:if test='menuType!="PC"'>
														...
														<td align="center">
															<s:if test='!"".equals(glcupload)'>
																<a href="#" type="button" class="btn btn-sm btn-outline-primary" onClick="lcupload(<s:property value="glcupload" />)"><i class="glyphicon glyphicon-book"></i></a>
															</s:if>
														</td>
													</s:if>	
												</s:if>
...
<%-- 													<a href="#" type="button" class="btn btn-sm btn-success" onClick="sentEMail(<s:property value="gactive" />)"><i class="glyphicon glyphicon-ok-sign"></i></a> --%>
													<button type="submit" onClick="sentEMailNew(<s:property value="gactive" />)" class="btn btn-sm btn-success"><i class="glyphicon glyphicon-ok-sign"></i></button>
												</td>
												<td align="center">
<%-- 													<a href="#" type="button" class="btn btn-sm btn-danger" onClick="sentEMail(<s:property value="gdeactive" />)"><i class="glyphicon glyphicon-remove-sign"></i></a> --%>
													<button type="submit" onClick="sentEMailNew(<s:property value="gdeactive" />)" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-remove-sign"></i></button>
												</td>
											</s:elseif>
											<s:elseif test='menuType=="QE" || menuType=="QS" || menuType=="BQE"'>
												<td> <s:property value="gvalidityDate" /> </td>
												...
												<s:if test='%{#session.product_id=="65"}'>
													<%-- <td align="center">
												   	    <button type="submit" onClick="editQuoteNew(<s:property value="gedit" />)" class="btn btn-sm btn-warning">
														    <i class="fas fa-pencil-alt"></i>
														</button>
													</td> --%>
													
													<td align="center">
														<s:if test='"0".equalsIgnoreCase(gpremium) || "0".equalsIgnoreCase(gvehCount)'>
														 	<button type="submit" onClick="editQuote(<s:property value="gedit" />)" class="btn btn-sm btn-warning">
														    	<i class="fas fa-pencil-alt"></i>
															</button>
														</s:if>
														<s:else>
															<button type="submit" onClick="editPolicy(<s:property value="gedit" />)" class="btn btn-sm btn-success">
														    	<i class="fas fa-pencil-alt"></i>
															</button>
														</s:else>
													</td>
...
<%-- 														<a href="#" onClick="sentEMail(<s:property value="gedit" />)"><i class="fa fa-envelope"></i></a> --%>
														<s:if test='"0".equalsIgnoreCase(gpremium) || "0".equalsIgnoreCase(gvehCount)'>
															<button type="submit" onClick="sentEMailQE(<s:property value="gedit" />)" class="btn btn-sm btn-outline-primary" disabled><i class="fa fa-envelope"></i></button>
														</s:if>
														<s:else>
															<button type="submit" onClick="sentEMailQE(<s:property value="gedit" />)" class="btn btn-sm btn-outline-primary"><i class="fa fa-envelope"></i></button>
														</s:else>
...
<%-- 														<a href="#" onClick="viewQuote(<s:property value="gquoteNo"/>)"><i class="fa fa-print"></i></a> --%>
														<button type="submit" onClick="viewQuote(<s:property value="gquoteNo"/>)" class="btn btn-sm btn-primary">
													    	<i class="fa fa-print"></i>
														</button>
													</td>
													<s:if test='%{#session.product_id=="65"}'>
...
<%-- 															<a href="#" onClick="viewQuoteDtl(<s:property value="gquoteNo"/>)"><i class="fa fa-eye"></i></a> --%>
															<%-- <button type="submit" onClick="viewQuoteDtl(<s:property value="gquoteNo"/>,'${report.gapplicationNo}')" class="btn btn-sm btn-info">
														    	<i class="fa fa-eye"></i>
															</button> --%>
															<button type="button" data-toggle="modal" data-target="#myModal" onClick="return viewQuoteDtl(this.form,<s:property value="gquoteNo"/>,'${report.gapplicationNo}','viewQuoteAjax')" class="btn btn-sm btn-info"> <i class="fa fa-eye"></i></button>
														</td>
													</s:if>
												</s:if>
												<td align="center">
<%-- 												<a href="#" onClick="sentEMail(<s:property value="greject" />)" ><i class="fa fa-window-close"></i></a> --%>
													<%--<button type="submit" onClick="sentEMail(<s:property value="greject" />)" class="btn btn-sm btn-danger"><i class="fa fa-window-close">11</i></button> --%>
													<button type="submit" onClick="sentEMailNew(<s:property value="greject" />)" class="btn btn-sm btn-danger"><i class="fa fa-window-close"></i></button>
<%-- 													<a href="#" type="button" class="btn btn-sm btn-danger" onClick="sentEMail(<s:property value="greject" />)"><i class="glyphicon glyphicon-remove-sign"></i></a> --%>
												...
												<s:if test='%{#session.product_id=="65"}'>
													<td> <s:property value="gnrc" /> </td>
													<td> <s:property value="gpassport" /> </td>
													<td> <s:property value="gcompanyRegNo" /> </td>
												</s:if>
											</s:elseif>
											<s:elseif test='menuType=="RP"  || menuType=="BRP"'>
												<td> <s:property value="gpolicyNo" /> </td>
											...
											<s:elseif test='menuType=="RU" || menuType=="RA" || menuType=="BRU"'>
												<td align="center">
<%-- 												<a type="button" class="btn btn-sm btn-warning" href="#" onClick="editQuote(<s:property value="gedit" />)"><i class="glyphicon glyphicon-pencil" ></i></a> --%>
												<button type="submit" onClick="editQuote(<s:property value="gedit" />)" class="btn btn-sm btn-warning">
												    <i class="fas fa-pencil-alt"></i>
												</button>
...
<%-- 													<a href="#" onClick="viewQuote(<s:property value="gquoteNo" />)" ><i class="fa fa-print"></i></a> --%>
												...
												<td align="center">
													<button type="submit" onClick="sentEMailNew(<s:property value="greject1" />)" class="btn btn-sm btn-danger"><i class="fa fa-window-close"></i></button>
												</td>
											</s:elseif>
											<s:elseif test='menuType=="RR"'>
											...
											<s:elseif test='menuType=="C"'>
												...
												<td align="center">
										            <div class="action_icons">
										               <a href="#" data-refresh="true" data-keyboard="false" data-toggle="modal" data-target="#custModal" onclick="fnEdit('<s:property value="gcustomerId" />','custEditAjax')"><i class="fas fa-pencil-alt"></i></a>
										            </div>
												</td>
												<div class="container modal_VehicleDetails">
...
function getRenew(policyno,mobileNo) {
	document.report.policyNo.value = policyno;
	document.report.mobileNo.value = mobileNo;
	document.report.action = '${pageContext.request.contextPath}/renewPolicyQuickRenewal.action';
	document.report.submit();
}
...
function editQuote(applicationNo,quoteNo, status,customerId, contentTypeId) { 
	//alert(applicationNo+", "+quoteNo+", "+status+", "+customerId+", "+contentTypeId);
	...
	if(30=='<s:property value="#session.product_id"/>') {
		...
		if(status=='RA') {
			document.report.action = "${pageContext.request.contextPath}/quotationMotor.action";
		}
		else{
			document.report.action = "${pageContext.request.contextPath}/editQuoteNewMotor.action";
		}
...
function editPolicy(applicationNo,quoteNo, status,customerId, contentTypeId) { 
	...
	if(30=='<s:property value="#session.product_id"/>') {
		...
		document.report.actionType.value='editQuoteQE';
		document.report.action = "${pageContext.request.contextPath}/vehicleDtlMotor.action";
	} else if(3=='<s:property value="#session.product_id"/>' || 11=='<s:property value="#session.product_id"/>') {
		document.report.action = "${pageContext.request.contextPath}/editQuoteQuotation.action";
	}else if(33 == '<s:property value="#session.product_id"/>')
		document.report.action = "${pageContext.request.contextPath}/initTravel.action";
...
function sentEMailNew(applicationNo,linkType,quoteNo){ // greject,reject1,
	document.report.menuType.value='<s:property value="%{menuType}" />';
	document.report.applicationNo.value=applicationNo;
	document.report.linkType.value=linkType;
	document.report.quoteNo.value=quoteNo;		
	document.report.action='${pageContext.request.contextPath}/mailNewReport.action';
	document.report.submit();
}
function sentEMailQE(applicationNo,quoteNo,linkType,customerId, contentTypeId){
	//document.report.menuType.value='<s:property value="%{menuType}" />';
	document.report.applicationNo.value=applicationNo;
	//document.report.linkType.value='QUOTEMAIL';
	document.report.quoteNo.value=quoteNo;
	//document.report.quoteStatus.value='EmailQuote';
	document.report.action='${pageContext.request.contextPath}/emailQuoteMotor.action';
	document.report.submit();
}
...
function viewQuoteDtl(frm, quote, applicationNo, id) {
	var val = '?quoteNo='+quote
		+ '&applicationNo='+applicationNo;
	postRequest('${pageContext.request.contextPath}/viewQuoteInfoNewMotor.action'+val, id);
}
...
function fnUpdCustomer(custId) {
	//var val = '?customerId='+custId;
	document.report.mode.value='custUpd';
	document.report.customerId.value=custId;
	postFormRequest('${pageContext.request.contextPath}/updateCustDetailAjaxCustomer.action', 'custEditAjax','report');
	return false;
}
