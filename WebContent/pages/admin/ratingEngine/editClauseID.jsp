                                                           ...
                                                           <s:else>
                                                            ...
                                                            <tr>
                                                               <td>&nbsp;</td>
																...
																<td id="covername">
																	<s:select name="covername" id="covername" cssClass="inputSelect" cssStyle="width: 51%;" headerKey="-1" headerValue="--Select--"  list="coverNames" listKey="COVER_ID" listValue="COVER_NAME" disabled="true"/>
																</td>
