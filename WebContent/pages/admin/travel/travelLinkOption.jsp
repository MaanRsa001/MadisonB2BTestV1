    ...
    <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#E5E5E5">
      <tr>
        ...
        <s:form id="form1" name="form1" method="post" theme="simple">
            ...
            <tr><td>&nbsp;</td></tr>
            <tr>
	           <td class="heading" colspan="2"><s:label key="Travel Link Option" /></td>
	        </tr>
            <tr>
			...
			<s:elseif test="'history'.equalsIgnoreCase(display)">
		 		<table align="center" width="100%">
		        	...
		        	<tr><td align="center">
			      	<display:table name="list" pagesize="10"  requestURI="${pageContext.request.contextPath}/linkoptionTravelConfigure.action" class="table" uid="row" id="record" style="align:center; " cellpadding="1" cellspacing="1"  varTotals="totals" >
					...
					<display:column sortable="true" style="text-align:center;" title="Scheme Id" property="SCHEME_ID"/>
					<display:column sortable="true" style="text-align:center;" title="Option Id" property="OPTION_ID"/>
...
{
if(from == 'edit'){
document.form1.action = "${pageContext.request.contextPath}/linkoptionTravelConfigure.action?optionId="+val+'&display='+from;
}else{
document.form1.action = "${pageContext.request.contextPath}/linkoptionTravelConfigure.action?display="+from;
}
document.form1.submit();
}
function fnScheme(val){
	postRequest('${pageContext.request.contextPath}/linkoptionTravelConfigure.action?reqFrom=scheme&productId='+val, 'schemeSelect');
}
function fnOption(val){
	postRequest('${pageContext.request.contextPath}/linkoptionTravelConfigure.action?reqFrom=option&schemeId='+val, 'optionSelect');
}
</script>
</div>
</div>
