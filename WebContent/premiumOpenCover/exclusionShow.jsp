...
<%--<input type='text' name='search' value="<%=request.getParameter("search")==null?"":request.getParameter("search")%>"  >&nbsp;&nbsp;<input type='submit'  value='Search' onclick="controls()"  accesskey='s'>--%>
	 ...
	 <%
       ...
       String option =request.getParameter("mode");
        ...
        totalConditions=ct.getExclusionsFromMaster(belongingBranch,coverNo);
        ...
        else
        {
	        ...
	        //{
			selectedAddons=(HashMap)ct.getExclusionFromOpenCoverMaster(coverNo);
        }    
        %>
<table width="100%"  border="0" cellspacing="0" cellpadding="0" style="align:justify; font-family:Arial;font-size:12px;font-weight:normal;">
	<tr class="">    	
		<td>&nbsp;<strong><span class="heading"> Exclusions</span> </strong></td>
	</tr>			
	<tr >
		<td>
	...
	<tr>
		<td>
			<table class="footable" width="100%">
				...
				<tr>
					<th width="10%"></th>
					<th width="10%">Exclusion&nbsp;ID</th>
					<th width="40%">Exclusion Description</th>
		...
		dummyKName=(String)conditionsList.get(""+(dummyK))==null?"0":(String)conditionsList.get(""+(dummyK));
			...
			if(conditionsList.size()>0)
			{
				for(int k=0;k<conditionsList.size();k++)
				{
					...
					String commName_S="",desc_S="",checkStatus="unchecked",descCommodity="",descCover="";
...
%> 
        ...
        <td colspan="4" align="right"> <input value="<%=(effectDate==""?todayStr:effectDate	)%>" name="effectDate" size="20" type="hidden" class="fde1"> </td>
        </tr>
	<%
		  }
	%>
	...
	<tr>
		<td align="center">
			...
			<a href="javascript:window.close()"  class="buttonsMenu" > <img src="../images/Cancel.jpg" ></a>
			&nbsp;&nbsp;&nbsp;
