        			...
        			<div class="panel-body">
	        			<div class="row">
	        				<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        						<div class="text"><s:text name="Policy Type"/><font color="red">*</font></div>
        						<div class="tbox">
        							<s:select name="policyType" id="policyType" list="#{'':'----select----','1':'Comprehensive','2':'Third Party Fire and Theft','3':'Third Party Liability Only'}"  cssClass="inputBoxS tooltipContent" disabled="#disable1" cssStyle="color: #000000;"/>
        						</div>
        					</div>
	        			</div>
        				<div class="row">
									...
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										...
										<!--<div class="row">
       										<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
       											...
       											<div class="tbox">
       												<s:textfield name="regNoList[0]" id="regNoList" cssClass="inputBox tooltipContent" data-content="Your vehicle registration number as shown on white book without spaces e.g. ALC3245" maxLength="20" disabled="#endtDisable"/>
       											</div>
       										</div>
       										<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
       											<div class="text"><s:text name="motor.chassisNo" /><font color="red">*</font></div>
       											<div class="tbox">
       												<s:textfield name="chassisNoList[0]" id="chassisNoList" cssClass="inputBox tooltipContent" data-content="Your vehicle Chassis number as indicated on white book without spaces. eg. AE110-0011442" maxLength="20" disabled="#endtDisable"/>
       											</div>
       										</div>
       										<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
       											<div class="text"><s:text name="motor.engineNo" /><font color="red">*</font></div>
       											<div class="tbox">
       												<s:textfield name="engineNoList[0]" id="engineNoList" cssClass="inputBox tooltipContent" data-content="Your vehicle Engine number as indicated on white book without spaces. eg. 4S-1394811" maxLength="20" disabled="#endtDisable"/>
       											</div>
       										</div>
       									</div>
       									<div class="row">
       										<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
       											...
       											<div class="tbox">
       												<s:select name="vehicleColourIdList[0]" id="vehicleColourIdList" list="vehicleColourList" listKey="CODE" listValue="CODEDESC" headerKey="" headerValue="---Select---" cssClass="inputBoxS tooltipContent" data-content="Your vehicle color as indicated on white book" disabled='#endtDisable'/>
       											</div>
       										</div>
       										<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
       											<div class="text"><s:text name="motor.leasedYN" /><font color="red">*</font></div>
       											<div class="tbox">
       												<s:radio name="leasedYNIdList[0]" id="leasedYNIdList" list="#{'Y':'Yes','N':'No'}" value='%{(leasedYNIdList==null||leasedYNIdList[0]==null||"".equals(leasedYNIdList[0]))?"N":leasedYNIdList[0]}' onclick="toggleLeasedYN(this.value,'%{#status.index}');" disabled="#endtDisable" cssClass="tooltipContent" data-content="Indicate whether vehicle has been leased or not" />
       											</div>        											
       										</div>
       										<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
       											<div class="text"><s:text name="motor.bankOfFinance" /><font color="red">*</font></div>
       											<div class="tbox">
       												<s:select name="bankOfFinanceIdList[0]" id="bankOfFinanceIdList" list="bankOfFinanceList" listKey="CODE" listValue="CODEDESC" headerKey="" headerValue="---Select---" cssClass="inputBoxS tooltipContent" data-content="If Leased, indicate the bank that financed the lease" disabled='%{(#endtDisable || leasedYNIdList[0]==null||"".equals(leasedYNIdList[0])||"N".equals(leasedYNIdList[0]))?"true":"false"}'/>
       											</div>
       										</div>
       									</div>
       									...
       									<div class="row">
       										<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
												...
												<div class="tbox">
													<s:textfield name="cubicCapacityList[0]" id="cubicCapacity" cssClass="inputBox tooltipContent" data-content="The size of your vehicle’s engine in litres e.g. 2000" maxLength="5" onkeyup="checkNumbers(this);" disabled="#disable1"/>
												</div>
											</div>
       										<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
					       					...
					       					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
       											...
       											<div class="tbox">
       												<s:submit type="button" value="Attach Documents" onclick="return uploadDocuments('%{vehicleIdList[0]}');" cssClass="btn btn-sm btn-danger tooltipContent" data-content="Attach supporting documentse.g white book, drivers licence, letter of no claim record,  pictures of the vehicle" />
       											</div>
       										</div>
       									</div>-->
       									<div class="row addVehicle" style="display: none;">
											<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
												...
												<div class="row">
													<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
														...
														<div class="tbox">
															<%-- <div id="ncbAjax"> <s:select name="noClaimBonusIdList[0]" id="noClaimBonus" list="#{'':'---Select---','0':'0','1':'1','2':'2','3':'3'}" onchange="toggleNCB(this.value);" cssClass="inputBoxS tooltipContentR" data-content="The number of years you have insured your vehicle without making a claim" disabled="#disable1"  theme="simple"/> </div>--%>
															<div id="ncbAjax"> <s:select name="noClaimBonusIdList[0]" id="noClaimBonus" list="noClaimBonusList" headerKey="" headerValue="---Select---" onchange="toggleNCB(this.value);" cssClass="inputBoxS tooltipContentR" data-content="The number of years you have insured your vehicle without making a claim" disabled="#disable1" listKey="CODE" listValue="CODE" theme="simple"/> </div>
														</div>
													</div>
													<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
														<div class="text">
														...
														<div class="tbox">
															<s:radio name="claimYNIdList[0]" id="claimYN" list="#{'Y':'Yes','N':'No'}" value="%{claimYNIdList==null?'N':claimYNIdList[0]}" onclick="toggleClaimDetails(this.value);" cssClass="tooltipContent" data-content="Indicate whether you have made any claims" disabled="#disable1"/>
														</div>
													</div>
													<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
														<div class="text">
       									...
       									<div class="row prevInfo">
       										<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
       											<div class="text"><s:text name="motor.prevPolicyNo" /></div> 
       											<div class="tbox">
       												<s:textfield name="prevPolicyNoList[0]" id="prevPolicyNoList" cssClass="inputBox tooltipContent" maxLength="30"  data-content="Policy number you previously held with Madison or another Insurer" />
       											</div>
       										</div>
       										<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
       											<div class="text"><s:text name="motor.prevInsExpiryDate" /><s:text name="(DD/MM/YYYY)" /></div>
       											<div class="tbox">
       												<s:textfield name="prevExpiryDateList[0]" id="prevExpiryDateList" cssClass="inputBox datePicker prevExpiryDateList tooltipContentL" maxLength="10"  data-content="Date your previous policy expired" />
       											</div>
       										</div>
       										<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
       											<div class="text"><s:text name="motor.prevInsCompany" /></div>
       											<div class="tbox">
       												<s:select name="prevInsCompanyIdList[0]" id="prevInsCompanyIdList" list="insCompanyList" listKey="CODE" listValue="CODEDESC" headerKey="" headerValue="---Select---" cssClass="inputBoxS tooltipContent" data-content="Insurance Company that you took out your previous policy with" />
       											</div>
       										</div>
       									</div>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" align="center">
		        		...
		        		<s:if test='"admin".equalsIgnoreCase(#session.usertype)'>
							...
							<input type="button" name="Submit3" class="btn btn-sm btn-success" value="Proceed" onclick="this.form.actionType.value='getQuote';disableForm(this.form,false,'');"/>
		        		</s:if>
		        		<s:else>
			              	...
			              	<span id="proceedSpan" style='${"2"!=premiumType?"":"display:none;"}'> <s:submit name="Submit3" type="submit" cssClass="btn btn-sm btn-success tooltipContent" data-content="Used to get quote for the supplied vehicles details" value="Proceed" onclick="this.form.actionType.value='getQuote';fnNewsubmit();disableForm(this.form,false,'');"/> </span>
						</s:else>
					</div>
				</div>
				<br class="clear" />
