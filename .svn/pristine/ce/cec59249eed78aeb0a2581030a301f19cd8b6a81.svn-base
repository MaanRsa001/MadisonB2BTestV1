	...
	<s:set var="claimIntimUploadList" value="%{claimIntimUploadList}"/>
							...
							<s:else>	
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											<br class="clear"/>
												...
												<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">				
								        			<div class="col-md-12">
								                		<h3><s:text name="Documents" /></h3><hr>
							                		</div>
														...
														<table id="QuoteDocTable" class="table-sm table table-bordered table-hover" cellspacing="0" width="100%">
															...
															<tbody>
																...
																<tr>
																	...
																	<td>
																		<s:select name="documentIdList[0]" id="documentIdList[0]" cssClass="form-control" list="#{'Others':'Others'}" headerKey="" headerValue="-Select-" />
																	</td>
																	<td>
																		<s:file name="upload" id="upload[0]" cssClass="inputBox"/>
																	</td> 
																	<td>
																		<s:textfield name="docDescription[0]"  id="docDescription[0]" cssClass="form-control" cssStyle="text:" maxlength="50"/>
																	</td>
		...
		function docupload() {
			...
			//alert("i "+i+"size "+parseInt(size));
				document.form1.action = "${pageContext.request.contextPath}/submitdocumentB2BClaimIntimation.action";
       ...
       cell.appendChild(element);
		...
		function wclose() {
			document.form1.action = "${pageContext.request.contextPath}/insertB2BClaimIntimation";
			document.form1.submit();
		}
		...
		function deleteDoc(filePath) {
			...
			if (decision==true){
				document.getElementById('filePath').value = filePath;
				document.form1.action = "${pageContext.request.contextPath}/deletedocumentB2BClaimIntimation";
				document.form1.submit();
				}
			return false;
		}
		function clmSuccess(){
			...
			if (decision){
				document.form1.action = "${pageContext.request.contextPath}/clmCompleteB2BClaimIntimation.action";
				document.form1.submit();
			}
			return false;
		}
