...
public class LogInService {
    ...
    public String sendPasswordMail(Map<String, String> details, String temp){
    	...
    	try{
	    	if(details !=null && !details.isEmpty()){
	    		...
	    		String subject = "Madison-Password Reset";
    ...
    public String getMailSignature(){
    	...
    	msg.append("Best Regards,<br /><br />Madison Admin Team");
    ...
    public void sendResponseMail(final String SMTP_HOST_NAME, final String user,  final String pwd, final String SMTP_MAIL_FROM, final String subject,
    	...
    	try{
			...
			InternetAddress addressFrom = new InternetAddress(SMTP_MAIL_FROM, "Madison");
	...
	public String getMobileNumber(CommonBean bean) {
		return dao.getMobileNumber(bean);
	}

	public boolean setPasswordNew(CommonBean bean) {
		return dao.setPasswordNew(bean);
	}
	
	public int getPasswordCountNew(CommonBean bean) {		 
		return dao.getPasswordCountNew(bean);
	}

	public List<Map<String, Object>> getProductListWithId(String userName, String branch, String product,String loginType) {
		return dao.getProductListWithId(userName,branch,product,loginType);
	}

	public Map getLoginDetails(String agencyCode,String type) {
		return dao.getLoginDetails(agencyCode,type);
	}
}