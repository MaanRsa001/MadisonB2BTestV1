		...
		<div class="vehDtl">
			<div class="Card_Parent card">
				<div class="panel-heading">
					<h3><s:text name="label.broker.selection"/></h3><hr>
				</div><br>
				<div class="panel-body">
					<table class="table table-bordered table-hover" cellspacing="0" width="100%" id="tadaTableNew">
						...
						<tr>
							<td align="center"> <input type="checkbox"  value="${record.BRANCH_CODE}" id="checkbox${record.BRANCH_CODE}" /> </td>
...
<div>
	<div align="center">
		...
		<input name="back" type="button" class="btn btn-sm btn-danger" onclick="javascript:window.close()" value="Close" style ="cursor:hand"/>
	</div>
</div>
</s:form>
<script type="text/javascript">
