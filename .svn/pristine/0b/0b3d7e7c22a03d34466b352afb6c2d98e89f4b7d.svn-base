		...
		<div class="container vehDtl">
			...
			<div class="VehicleTableheading">
               <div class="row">
                  ...
                  <s:else>
                  	<div class="col-lg-6 col-md-6">
	                    	<h3><s:text name="INCLUDED BROKER" /></h3>
	                  </div>
							...
							<table class="table table-bordered table-hover" cellspacing="0" width="100%" id="tadaTable">
								...
								<tr>
									...
									<td> 
										...
										<s:hidden name="brokerCode[%{#stat.index}]" id="brokerCode[%{#stat.index}]" value="%{AGENCY_CODE}"/> 
									</td>
									<td> <s:property value="AGENCY_CODE" /> </td>
									<td> <s:property value="COMPANY_NAME" /> </td>
									<td> <s:property value="BRANCH_NAME" /> </td>
									<td> 
										<s:select name="productId[%{#stat.index}]" id="productId_%{#stat.index}" list="%{PRODUCT_LIST}" cssClass="productSelect" style="z-index: 1;" listKey="PRODUCT_ID" listValue="PRODUCT_NAME" headerKey="" label="" multiple="true" />
										<%--
...
/*
<s:iterator value="productId" status="stat">
