...
public class UnderwriterMgtBean{
	...
	private List<Boolean> statusChk;
	...
	/**
	 * @return the statusChk
	 */
	public List<Boolean> getStatusChk() {
		return statusChk;
	}

	/**
	 * @param statusChk the statusChk to set
	 */
	public void setStatusChk(List<Boolean> statusChk) {
