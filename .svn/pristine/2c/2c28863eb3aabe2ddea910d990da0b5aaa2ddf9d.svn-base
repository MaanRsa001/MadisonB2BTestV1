...
<script type="text/javascript">
if(window.opener.BrokerInfoEdit.subBranchId.value.length>=1){
	var val=window.opener.BrokerInfoEdit.subBranchId.value;
...
function fnsubmit(){
	...
	window.opener.BrokerInfoEdit.subBranchId.value=checkedItems;
	window.close();
}
</script>
</body>
