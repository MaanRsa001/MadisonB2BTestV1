				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<s:if test="linkType=='MAIL' && reqFrom=='QUOTEMAIL'">
						<div class="panel panel-primary">
							<div class="panel-heading"> <h3><s:text name="E-Mail Quote" /></h3> </div><hr>
							<div class="panel-body">
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
										...
										<div class="tbox"><s:textfield name="quoteMailIds" cssClass="form-control" /></div>
									</div>
								</div>
								<br class="clear" />
								<div class="row">
					...
					<s:elseif test="linkType=='LAPSED'">
						<div class="panel panel-primary">
							<div class="panel-heading"> <h3><s:label key="Rejected Quote" /></h3> </div><hr>
							<div class="panel-body">
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										<s:actionerror cssStyle="color: red;" />
								...
								<div class="row">
									<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
										...
										<div class="tbox">
											<s:select name="lapsedRemarks" list="lapsedReason" headerKey="" headerValue="---Select---" listKey="DETAIL_NAME" listValue="DETAIL_NAME" cssClass="form-control" />
										</div>
									</div>
								</div>
								<br class="clear" />
...
function fnsubmit(forms) {			
	forms.action = "${pageContext.request.contextPath}/mailNewReport.action";
	forms.submit();
}
</script>
</body>
