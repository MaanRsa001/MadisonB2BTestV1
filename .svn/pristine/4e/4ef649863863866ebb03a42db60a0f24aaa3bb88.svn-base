...
public String quoteGeneration()
{
	...
	{
		LogManager.debug("Exception in QuoteGeneration {"+e+"}");e.printStackTrace();
	}
	return error;
}
public String policyGeneration()
{
	try
	{
		...
		LogManager.push("PolicyNo: "+policyNo);
	...
	{
		LogManager.push("Error in Policy Generation: "+e);
		LogManager.debug(e);
	}
...
public String receiptGeneration(){
	String filePath="";
	try {
		LogManager.push("PolicyNo: "+info.getPolicyNo());
...
public String docGeneration(String docType)
{
	...
	{
		LogManager.push("Error in docGeneration: "+e);
	}
	return error;
}
...
public boolean updateReferralDetails()
{
	...
	{
		LogManager.debug("Exception in updateReferralDetails {"+e+"}");e.printStackTrace();
	}
	return referralType;
}
