...
public class ReportBean{
	...
	private String ginstallmentYN;
	private String gmerchent;
	
	private String gvehCount;
	private String gnrc;
	private String gpassport;
	private String gcompanyRegNo;
	private String griskId;
	private String gchassisNo;
	...
	/**
	 * @param ginstallmentYN the ginstallmentYN to set
	 */
	public void setGinstallmentYN(String ginstallmentYN) {
		this.ginstallmentYN = ginstallmentYN;
	}
	/**
	 * @return the ginstallmentYN
	 */
	public String getGinstallmentYN() {
		return ginstallmentYN;
	}
	/**
	 * @param gmerchent the gmerchent to set
	 */
	public void setGmerchent(String gmerchent) {
		this.gmerchent = gmerchent;
	}
	/**
	 * @return the gmerchent
	 */
	public String getGmerchent() {
		return gmerchent;
	}
	public String getGvehCount() {
		return gvehCount;
	}
	public void setGvehCount(String gvehCount) {
		this.gvehCount = gvehCount;
	}
	public String getGnrc() {
		return gnrc;
	}
	public void setGnrc(String gnrc) {
		this.gnrc = gnrc;
	}
	...
	public String getGcompanyRegNo() {
		return gcompanyRegNo;
	}
	public void setGcompanyRegNo(String gcompanyRegNo) {
		this.gcompanyRegNo = gcompanyRegNo;
	}
	public String getGriskId() {
		return griskId;
	}
	public void setGriskId(String griskId) {
		this.griskId = griskId;
	}
	public String getGchassisNo() {
		return gchassisNo;
	}
	public void setGchassisNo(String gchassisNo) {
		this.gchassisNo = gchassisNo;
	}
