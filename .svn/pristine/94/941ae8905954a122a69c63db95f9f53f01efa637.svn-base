...
function checkDecimals6_4(obj) {
	return commonCheckDecimals(obj, 6, 4, '1234567890.-', false);
}
function checkDecimals10_4(obj) {
	return commonCheckDecimals(obj, 10, 4, '1234567890.-', false);
}
function checkDecimals4_2(obj) {
	return commonCheckDecimals(obj, 4, 2, '1234567890.-', false);
}
