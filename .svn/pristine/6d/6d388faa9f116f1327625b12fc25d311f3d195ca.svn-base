...
public class CommodityRateCalculator extends MyJdbcTemplate
{
	...
	public String getCommodityRate( String modeOfTransport,String coverage,String conveyanceType,String destCountryId,
		 String commodity,String fragile,double localSumInsured,String branch,String policyStartDate,String applicationNo,String packageType)
		{
			...
			try
			{
				...
				LogManager.info("baseRate:"+baseRate+"factor1(sum insured):"+factor1+"factor2(fragile/non fragile):"+factor2+"factor3(dest country):"+factor3+"factor4(Conveyance):"+factor4+"factor5(commodity):"+factor5+"wsrccRates:"+wsrccRates+"marineRates:"+marineRate+"(factor6)packageType:"+factor6);
			}catch(Exception e){
	...
	{
		String deductYes="",deduct="0",amount="0";
