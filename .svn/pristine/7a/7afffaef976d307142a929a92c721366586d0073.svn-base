...
public class ServletExceptionHandler extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		LogManager.info("royal test common exception from JSP doGet method()");
		...
		LogManager.info("Exception object printed by kanaka --> "+exception);
		if (exception != null) {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		LogManager.info("royal test common exception from JSP doPost method()");
		res.setContentType("text/html");
		PrintWriter pw = res.getWriter();
