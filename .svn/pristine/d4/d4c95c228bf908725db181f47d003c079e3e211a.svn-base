											...
											<s:if test='"edit".equals(from)'>
												...
												<tr><td bgcolor="#FFFFFF">
													<display:table name="lcList" pagesize="" requestURI="" class="table" uid="row" id="record">
														...
														<display:column sortable="true" style="text-align:right;font-size:13px;height:30px;" title="Actual Amount" property="ACTUAL_AMT" format="{0,number,0.00}"/>
														<display:column sortable="true" style="text-align:right;font-size:13px;height:30px;" title="Used Amount" property="USED_AMT" format="{0,number,0.00}"/>
														<display:column sortable="true" style="text-align:right;font-size:13px;height:30px;" title="Available Balance" property="LC_BALANCE_AMOUNT" format="{0,number,0.00}"/>
													</display:table>
												</td></tr>
												<tr style="height: 10px"><td>&nbsp;</td></tr>
											</s:if>
