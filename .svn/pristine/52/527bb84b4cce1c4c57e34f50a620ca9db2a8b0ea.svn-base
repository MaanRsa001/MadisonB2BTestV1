...
<body>
<s:form id="cyclinder" name="cyclinder" action="" theme="simple">
	<div class="container-fluid">
		<div class="row">
			<div class="col-xs-12">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<s:text name="label.cyclinderMaster"/>
						<s:if test='mode == "list"'>
							<div class="pullRight">
							...
							<div class="row">
								<table class="display responsive no-wrap" id="gridTableMake" width="100%" cellspacing="0">
									...
									<tr>
										...
										<th><s:text name="label.cyclinderCode"/></th>
										<th><s:text name="label.cyclinderDescEng"/></th>
										<th><s:text name="label.cyclinderDescAra"/></th>
						...
						<div class="panel-body">
							<div class="row">									
								<s:if test="hasActionErrors()">
									<font cyclinder="red"><s:actionerror cssStyle="list-style: none;"/></font>
								</s:if>
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
									<div class="form-cyclinder">
    									<label><s:text name="label.cyclinderCode"/><font cyclinder="red">*</font></label>
    									<s:textfield name="" cssClass="form-control" maxlength="50"></s:textfield>
									</div>
								</div>
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
									<div class="form-cyclinder">
    									<label><s:text name="label.cyclinderDescEng"/><font cyclinder="red">*</font></label>
    									<s:textfield name="" cssClass="form-control" maxlength="50"></s:textfield>
									</div>
								</div>
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
									<div class="form-cyclinder">
    									<label><s:text name="label.cyclinderDescAra"/><font cyclinder="red">*</font></label>
    									<s:textfield name="" cssClass="form-control" maxlength="50"></s:textfield>
									</div>
								</div>
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
									<div class="form-cyclinder">
    									<label><s:text name="label.typeOfBody" /><font cyclinder="red">*</font></label>
    									<s:select list="#{}" cssClass="form-control" headerKey="" headerValue="---Select---" />
									</div>
								</div>															
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
									<div class="form-cyclinder">
    									<label><s:text name="lable.master.effectiveDate" /><font cyclinder="red">*</font></label>
								...
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-4">
									<div class="form-cyclinder">
    									<label><s:text name="label.master.status" /><font cyclinder="red">*</font></label><br/>
...
<script type="text/javascript">
	function funSubmit(mode,val){
		document.cyclinder.action='cyclinderMotorAdminNew.action?mode='+mode;
		document.cyclinder.submit();
	}
	function funBack(){
		document.cyclinder.action='cyclinderMotorAdminNew.action?mode=list';
		document.cyclinder.submit();
	}
</script>
</body>
